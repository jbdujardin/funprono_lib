...
mixin _$FpBet {
 ...
 int? get leagueId; String? get userId; String? get fixtureId; int? get homeBet; int? get awayBet; String? get fixtureRound; int? get fixtureTimestamp;@JsonKey(name: '\$id') String? get dbId;@JsonKey(name: '\$createdAt') DateTime? get createdAt;@JsonKey(name: '\$updatedAt') DateTime? get updatedAt;@JsonKey(name: '\$permissions') List<String>? get permissions;@JsonKey(name: '\$collectionId') String? get collectionId;@JsonKey(name: '\$databaseId') String? get databaseId;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,leagueId,userId,fixtureId,homeBet,awayBet,fixtureRound,fixtureTimestamp,dbId,createdAt,updatedAt,const DeepCollectionEquality().hash(permissions),collectionId,databaseId);
...
/// Create a copy of FpBet
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? leagueId = freezed,Object? userId = freezed,Object? fixtureId = freezed,Object? homeBet = freezed,Object? awayBet = freezed,Object? fixtureRound = freezed,Object? fixtureTimestamp = freezed,Object? dbId = freezed,Object? createdAt = freezed,Object? updatedAt = freezed,Object? permissions = freezed,Object? collectionId = freezed,Object? databaseId = freezed,}) {
...
switch (_that) {
case _FpBet() when $default != null:
return $default(_that.leagueId,_that.userId,_that.fixtureId,_that.homeBet,_that.awayBet,_that.fixtureRound,_that.fixtureTimestamp,_that.dbId,_that.createdAt,_that.updatedAt,_that.permissions,_that.collectionId,_that.databaseId);case _:
  return orElse();
...
class _FpBet implements FpBet {
   _FpBet({this.leagueId, this.userId, this.fixtureId, this.homeBet, this.awayBet, this.fixtureRound, this.fixtureTimestamp, @JsonKey(name: '\$id') this.dbId, @JsonKey(name: '\$createdAt') this.createdAt, @JsonKey(name: '\$updatedAt') this.updatedAt, @JsonKey(name: '\$permissions') final  List<String>? permissions, @JsonKey(name: '\$collectionId') this.collectionId, @JsonKey(name: '\$databaseId') this.databaseId}): _permissions = permissions;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,leagueId,userId,fixtureId,homeBet,awayBet,fixtureRound,fixtureTimestamp,dbId,createdAt,updatedAt,const DeepCollectionEquality().hash(_permissions),collectionId,databaseId);
...
/// Create a copy of FpBet
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? leagueId = freezed,Object? userId = freezed,Object? fixtureId = freezed,Object? homeBet = freezed,Object? awayBet = freezed,Object? fixtureRound = freezed,Object? fixtureTimestamp = freezed,Object? dbId = freezed,Object? createdAt = freezed,Object? updatedAt = freezed,Object? permissions = freezed,Object? collectionId = freezed,Object? databaseId = freezed,}) {
  return _then(_FpBet(
leagueId: freezed == leagueId ? _self.leagueId : leagueId // ignore: cast_nullable_to_non_nullable
as int?,userId: freezed == userId ? _self.userId : userId // ignore: cast_nullable_to_non_nullable
as String?,fixtureId: freezed == fixtureId ? _self.fixtureId : fixtureId // ignore: cast_nullable_to_non_nullable
